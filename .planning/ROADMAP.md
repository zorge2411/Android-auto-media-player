...
- [x] 01-01-live-timeline-PLAN.md — 1 Hz position ticker + TimeFormatter fixes/tests (wave 1)
- [x] 01-02-auto-hide-controls-PLAN.md — auto-hide timeline, tap/drag reveal (Action.PAN), stop icon → ic_close (wave 1)
