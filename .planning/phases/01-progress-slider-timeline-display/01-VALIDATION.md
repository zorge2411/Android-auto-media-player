...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 1-01-01 | 01 | 1 | FEAT-1-AC4 formatter | unit | `./gradlew :app:testDebugUnitTest --tests "*TimeFormatterTest*"` | ❌ W0 (created in task) | ✅ green (Android build + JVM harness) |
| 1-01-02 | 01 | 1 | FEAT-1-AC4 formatter fix | unit | `./gradlew :app:testDebugUnitTest --tests "*TimeFormatterTest*"` | ✅ after 1-01-01 | ✅ green (Android build + JVM harness) |
| 1-01-03 | 01 | 1 | FEAT-1-AC5 1 Hz ticker | build | `./gradlew :app:assembleDebug` | ✅ existing | ✅ green (Android build, 2026-09-25) |
| 1-02-01 | 02 | 1 | auto-hide timer | unit | `./gradlew :app:testDebugUnitTest --tests "*ControlsVisibilityControllerTest*"` | ❌ W0 (created in task) | ✅ green (Android build + JVM harness) |
| 1-02-02 | 02 | 1 | touch reveal bridge | build | `./gradlew :app:assembleDebug` | ✅ existing | ✅ green (Android build, 2026-09-25) |
| 1-02-03 | 02 | 1 | hidden state / screen wiring | build + unit | `./gradlew :app:assembleDebug :app:testDebugUnitTest` | ✅ existing | ✅ green (Android build, 2026-09-25) |
